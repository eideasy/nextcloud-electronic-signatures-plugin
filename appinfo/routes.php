...
return [
	'routes' => [
        ['name' => 'signApi#createRemoteSigningQueue', 'url' => '/create_signing_queue', 'verb' => 'POST'],
        ...
        //		['name' => 'signApi#createRemoteSigningQueue', 'url' => '/create_signing_queue_remote', 'verb' => 'POST'],
        ['name' => 'signApi#fetchSigningQueueFile', 'url' => '/fetch_signing_queue_file', 'verb' => 'POST'],
